...
- [x] Настроить RSS-ленту (@astrojs/rss, src/pages/rss.xml.ts)
- [x] Добавить FAQPage schema для статей с FAQ (frontmatter faq + JSON-LD)
- [x] Добавить полнотекстовый поиск (Pagefind, src/pages/search.astro)
- [x] Оптимизация изображений (lazy loading + decoding async)
